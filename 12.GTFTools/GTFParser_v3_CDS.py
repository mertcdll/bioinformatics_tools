...
class ParseGTFAttributes:
    ...
    def create_bed_file(self, data_from_ncbi = False):
        ...
        if data_from_ncbi:
            ...
            # Selecting only the 'CDS' features from the DataFrame
            bed_df = self.db.loc[self.db['feature'] == 'CDS', ['chr_name', 'start', 'end', 'gene', 'gene_id']]
        ...
        bed_df = self.db.loc[self.db['feature'] == 'CDS', ['chr_name', 'start', 'end', 'gene_name', 'gene_id']] #first bed
...
#folder_path = "/home/genwork2/Mert/02.BEDS/NCBI-hg19-CDS"
...
file_path = "/home/genwork2/Mert/ensemblgtf"
