...
class FastaVCF:
    def __init__(self, fasta, chromosome):
        self.fasta = fasta
        self.chromosome= chromosome
        self.outputLocations = f"Mert/DecipherVCF/Chr{self.chromosome}_GenomicVariants2.vcf"
        self.readFasta()
