...
class FastaVCF:
    ...
    def readFasta(self):
        ...
        for section in gfastasections[22:]:
            chrlines = section.split("\n")
            alias = chrlines[0].split()[0]
            chro = self.get_chromosome_name(alias)
            ...
            if chro:
                ...
                outputLocations = f"/home/genwork2/Mert/DecipherVCF/Allnew/Chr{chro}_GenomicVariants.vcf"
